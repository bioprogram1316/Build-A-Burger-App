...
class ContactData extends Component {
    ...
    inputChangedHandler = (event, inputIdentifier) => {
        ...
        /*{ // a deeper clone of the state form object excluding the config level, 
            //we would need to do another level clone down to get that safely cloned
            ...updatedOrderForm[inputIdentifier]
        };
        // update the state value with the user inputted value
